...
class HomeScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        onRefresh: () async {
          ...
          // Trigger your WeatherBloc to reload the data
          context.read<WeatherBloc>().add(FetchWeatherEvent(data: location!));
          // Wait until new state is emitted
          await context.read<WeatherBloc>().stream.firstWhere(
            (state) => state is! WeatherLoadingState,
          );
        },
  ...
  Widget _loadded(Weather weather, BuildContext context) => Stack(
    children: [
      Align(
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Row(
                children: [
                  Icon(Icons.pin_drop, color: Colors.red, size: 15),
                  SizedBox(width: 8),
                  Text(
                    weather.areaName!,
                    style: Theme.of(
            ...
            Column(
              ...
              children: [
                Image.asset(_getPath(weather.weatherMain ?? 'Clear')),
                Center(
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      ...
                      Icon(WeatherIcons.celsius, size: 78, color: Colors.white),
                    ],
                  ),
                ),
                Center(
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildInfos(
                      context,
                      'sunrise',
                      DateFormat().add_jmv().format(weather.sunrise!),
                      'assets/11.png',
                    ),
                    // sunset
                    _buildInfos(
                      context,
                      'sunset',
                      DateFormat().add_jmv().format(weather.sunset!),
                      'assets/12.png',
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    _buildInfos(
                      context,
                      'Max Temp',
                      weather.tempMax!.celsius!.toStringAsFixed(2),
                      'assets/13.png',
                    ),
                    _buildInfos(
                      context,
                      'Min Temp',
                      weather.tempMin!.celsius!.toStringAsFixed(2),
                      'assets/14.png',
                    ),
                  ],
                ),
